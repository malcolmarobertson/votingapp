...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_throw__ = __webpack_require__(31);
...
var VoterService = (function () {
    function VoterService(_http, baseUrl) {
        this._http = _http;
        this.myAppUrl = "";
        this.myAppUrl = baseUrl + 'api/Voter/';
    }
    VoterService.prototype.getVoters = function () {
        return this._http.get(this.myAppUrl + 'Index')
            .map(function (response) { return response.json(); })
            .catch(this.errorHandler);
    };
    VoterService.prototype.getVoterById = function (voterId) {
        return this._http.get(this.myAppUrl + 'Details/' + voterId)
            .map(function (response) { return response.json(); })
            .catch(this.errorHandler);
    };
    VoterService.prototype.saveVoter = function (voter) {
        return this._http.post(this.myAppUrl + 'Create', voter)
            .map(function (response) { return response.json(); })
            .catch(this.errorHandler);
    };
    VoterService.prototype.updateVoter = function (voter) {
        return this._http.put(this.myAppUrl + 'Edit', voter)
            .map(function (response) { return response.json(); })
            .catch(this.errorHandler);
    };
    VoterService.prototype.deleteVoter = function (voterId) {
        return this._http.delete(this.myAppUrl + 'Delete/' + voterId)
            .map(function (response) { return response.json(); })
            .catch(this.errorHandler);
    };
    VoterService.prototype.errorHandler = function (error) {
        console.log(error);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(38), __webpack_require__(42)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_voterroll_service__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_fetchdata_fetchdata_component__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_counter_counter_component__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_fetchvoter_fetchvoter_component__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_addvoter_addvoter_component__ = __webpack_require__(15);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModuleShared = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__components_fetchvoter_fetchvoter_component__["a" /* FetchVoterComponent */],
                __WEBPACK_IMPORTED_MODULE_12__components_addvoter_addvoter_component__["a" /* createvoter */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__angular_router__["RouterModule"].forRoot([
                    ...
                    { path: 'fetch-voter', component: __WEBPACK_IMPORTED_MODULE_11__components_fetchvoter_fetchvoter_component__["a" /* FetchVoterComponent */] },
                    { path: 'register-voter', component: __WEBPACK_IMPORTED_MODULE_12__components_addvoter_addvoter_component__["a" /* createvoter */] },
                    { path: 'voter/edit/:id', component: __WEBPACK_IMPORTED_MODULE_12__components_addvoter_addvoter_component__["a" /* createvoter */] },
                    { path: '**', redirectTo: 'home' }
                ])
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_1__services_voterroll_service__["a" /* VoterService */]]
        })
    ], AppModuleShared);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return createvoter; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_voterroll_service__ = __webpack_require__(4);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var createvoter = (function () {
    function createvoter(_fb, _avRoute, _voterService, _router) {
        this._fb = _fb;
    ...
    createvoter.prototype.ngOnInit = function () {
        var _this = this;
        if (this.voterId > 0) {
            this.title = "Edit";
            this._voterService.getVoterById(this.voterId)
                .subscribe(function (resp) { return _this.voterForm.setValue(resp); }, function (error) { return _this.errorMessage = error; });
        }
    };
    createvoter.prototype.save = function () {
        var _this = this;
        ...
        if (this.title == "Create") {
            this._voterService.saveVoter(this.voterForm.value)
                ...
                _this._router.navigate(['/fetch-voter']);
    ...
    createvoter.prototype.cancel = function () {
        this._router.navigate(['/fetch-voter']);
    };
    createvoter = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormBuilder"], __WEBPACK_IMPORTED_MODULE_2__angular_router__["ActivatedRoute"],
            __WEBPACK_IMPORTED_MODULE_3__services_voterroll_service__["a" /* VoterService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["Router"]])
    ], createvoter);
    return createvoter;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FetchVoterComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_voterroll_service__ = __webpack_require__(4);
...
var FetchVoterComponent = (function () {
    function FetchVoterComponent(http, _router, _voterService) {
        this.http = http;
        this._router = _router;
        this._voterService = _voterService;
        this.getVoters();
    }
    FetchVoterComponent.prototype.getVoters = function () {
        var _this = this;
        this._voterService.getVoters().subscribe(function (data) {
            _this.voterList = data;
        }, function (error) { return console.error(error); });
    };
    FetchVoterComponent.prototype.delete = function (voterId) {
        var _this = this;
        var ans = confirm("Do you want to delete customer with Id: " + voterId);
        if (ans) {
            this._voterService.deleteVoter(voterId).subscribe(function (data) {
                _this.getVoters();
            }, function (error) { return console.error(error); });
        }
    };
    FetchVoterComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            template: __webpack_require__(28)
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"], __WEBPACK_IMPORTED_MODULE_2__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_3__services_voterroll_service__["a" /* VoterService */]])
    ], FetchVoterComponent);
    return FetchVoterComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootstrap__ = __webpack_require__(12);
...
module.exports = "<!DOCTYPE html>\r\n<html>\r\n<head>\r\n    <meta charset=\"utf-8\" />\r\n    <title></title>\r\n</head>\r\n<body>\r\n\r\n    <h1>{{title}}</h1>\r\n    <h3>Voter</h3>\r\n    <hr />\r\n    <form [formGroup]=\"voterForm\" (ngSubmit)=\"save()\" #formDir=\"ngForm\" novalidate>\r\n\r\n        <div class=\"form-group row\">\r\n            <label class=\" control-label col-md-12\" for=\"Full Name\">Full Name</label>\r\n            <div class=\"col-md-4\">\r\n                <input class=\"form-control\" type=\"text\" formControlName=\"fullName\">\r\n            </div>\r\n            <span class=\"text-danger\" *ngIf=\"voterForm.hasError('required', 'fullName') && formDir.submitted\">\r\n                Name is required.\r\n            </span>\r\n        </div>\r\n        <div class=\"form-group\">\r\n            <button type=\"submit\" class=\"btn btn-default\">Save</button>\r\n            <button class=\"btn\" (click)=\"cancel()\">Cancel</button>\r\n        </div>\r\n    </form>\r\n</body>\r\n</html>  ";
...
module.exports = "<h1>Voter Data</h1>\r\n\r\n<p>This component demonstrates fetching Voter data from the server.</p>\r\n\r\n<p *ngIf=\"!voterList\"><em>Loading...</em></p>\r\n\r\n<p>\r\n    <a [routerLink]=\"['/register-voter']\">Create New</a>\r\n</p>\r\n\r\n<table class='table' *ngIf=\"voterList\">\r\n    <thead>\r\n        <tr>\r\n            <th>Voter Id</th>\r\n            <th>FullName</th>\r\n        </tr>\r\n    </thead>\r\n    <tbody>\r\n        <tr *ngFor=\"let voter of voterList\">\r\n            <td>{{ voter.voterId }}</td>\r\n            <td>{{ voter.fullName }}</td>\r\n            <td>\r\n            <td>\r\n                <a [routerLink]=\"['/voter/edit/', voter.voterId]\">Edit</a> |\r\n                <a [routerLink]=\"\" (click)=\"delete(voter.voterId)\">Delete</a>\r\n            </td>\r\n        </tr>\r\n    </tbody>\r\n</table>  ";
...
module.exports = "<div class='main-nav'>\r\n    <div class='navbar navbar-inverse'>\r\n        <div class='navbar-header'>\r\n            <button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-collapse'>\r\n                <span class='sr-only'>Toggle navigation</span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n            </button>\r\n            <a class='navbar-brand' [routerLink]=\"['/home']\">CryptoVote</a>\r\n        </div>\r\n        <div class='clearfix'></div>\r\n        <div class='navbar-collapse collapse'>\r\n            <ul class='nav navbar-nav'>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/home']\">\r\n                        <span class='glyphicon glyphicon-home'></span> Home\r\n                    </a>\r\n                </li>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/counter']\">\r\n                        <span class='glyphicon glyphicon-education'></span> Counter\r\n                    </a>\r\n                </li>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/fetch-data']\">\r\n                        <span class='glyphicon glyphicon-th-list'></span> Fetch data\r\n                    </a>\r\n                </li>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/fetch-voter']\">\r\n                        <span class='glyphicon glyphicon-th-list'></span> Fetch Voter\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
...
var ErrorObservable_1 = __webpack_require__(34);
